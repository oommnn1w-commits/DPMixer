...
echo "Running ETTm2 | pred_len=96"
python -u run.py \
    --is_training 1 \
    --label_len 0 \
...
echo "Running ETTm2 | pred_len=192"
python -u run.py \
    --is_training 1 \
    --label_len 0 \
    --batch_size $BATCH_SIZE \
...
echo "Running ETTm2 | pred_len=336"
python -u run.py \
    --is_training 1 \
    --label_len 0 \
    --batch_size $BATCH_SIZE \
...
echo "Running ETTm2 | pred_len=720"
python -u run.py \
    --is_training 1 \
    --label_len 0 \
    --batch_size $BATCH_SIZE \
...
echo "ETTm2 all experiments completed!"